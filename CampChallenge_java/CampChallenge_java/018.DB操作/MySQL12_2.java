 ...
 * @author ryo
 */
public class MySQL12_2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //パス
            final String result = "WEB-INF/jsp/MySQL12_4.jsp";
            ...
            int searchA = Integer.parseInt(request.getParameter("searchA"));
            Date searchB = Date.valueOf(request.getParameter("searchB"));
            ...
            //検索対象はHTMLのフォームから取得
            String searchText = "SELECT * FROM " + searchTa + " WHERE age =" + searchA + " OR birthday ='" + searchB + "'";
