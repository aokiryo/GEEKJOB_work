    ...
    <body>
        ...
        <%
            if (request.getParameter("txtName") != null) {
                String encodedName = URLEncoder.encode(request.getParameter("txtName"), "ISO-8859-1");
            ...
            if (request.getParameter("txtHobby") != null) {
                String encodedHobby = URLEncoder.encode(request.getParameter("txtHobby"), "ISO-8859-1");
